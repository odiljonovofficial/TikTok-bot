...
load_dotenv()
bot_token = os.environ.get('5262448005:AAEnzWm3kYgx-DtoLJYbHLD4S8dUmzo6cKM')
workers = int(os.environ.get('4'))
api = int(os.environ.get('9121527'))
hash = os.environ.get('a1032ec75bfec03b27310af38c62dcc3')
chnnl = os.environ.get('http://t.me/OdiljonovBlog')
BOT_URL = os.environ.get('odiljonov_tiktok_bot')
app = Client("evomarketing_ads", bot_token=bot_token, api_id=api, api_hash=hash, workers=workers)
